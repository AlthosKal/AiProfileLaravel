...
/**
 * Estrategia concreta de importación desde archivos CSV.
 *
 ...
 */
readonly class CsvImportStrategy implements ImportInterface
{
    /**
    ...
    {
        Excel::import($this->sheet, $file, null, ExcelType::CSV);
    }
}
